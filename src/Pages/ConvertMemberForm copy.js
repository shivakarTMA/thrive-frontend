...
const ConvertMemberForm = ({
  ...
  const uploadDocuments = async ({ memberId, documents }) => {
    try {
      // ===============================
    ...
    onSubmit: async (values) => {
      ...
      if (step === stepValidationSchemas.length - 1) {
        try {
          ...
          if (hasAnyNewFile) {
            try {
              await uploadDocuments({ memberId, documents });
      ...
      try {
        ...
        if (data) {
          ...
          formik.setValues({
            ...
            club_data: data.club_data || { name: "", state: "", country: "", is_corporate_id: false },
            productType: "MEMBERSHIP_PLAN",
          });
                        ...
                        {hasExistingDocs && !isEditingDocs && (
                          <button
                            ...
                            onClick={() => {
                              ...
                              formik.setFieldTouched("id_proof_card_front", false);
                              formik.setFieldTouched("id_proof_card_back", false);
                                ...
                                <div className="flex space-x-2 mt-2">
                                  ...
                                  <button
                                    ...
                                    onClick={() => {
                                      ...
                                      setPreviewImage(
                                        getPreview(formik.values.id_proof_card_front)
                                      );
                                  ...
                                  {(isEditingDocs || !formik.values.id_proof_card_front) && (
                                    <label className="inline-flex items-center px-3 py-2 text-sm text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-md cursor-pointer">
                                      ...
                                      <input
                                        ...
                                        accept="image/*"
                                        onChange={(e) =>
                                          handleFileUpload(e, "id_proof_card_front")
                                        }
                                      />
                                    </label>
                                  )}
                                ...
                                <div className="flex space-x-2 mt-2">
                                  ...
                                  <button
                                    ...
                                    onClick={() => {
                                      ...
                                      setPreviewImage(
                                        getPreview(formik.values.id_proof_card_back)
                                      );
                                      setShowPreviewModal(true);
                                    }}
                                    className="inline-flex items-center px-3 py-2 text-sm text-blue-600 bg-blue-50 hover:bg-blue-100 rounded-md"
                                  ...
                                  {/* ✅ UPLOAD BUTTON (ONLY WHEN EDITING OR EMPTY) */}
                                  {(isEditingDocs || !formik.values.id_proof_card_back) && (
                                    <label className="inline-flex items-center px-3 py-2 text-sm text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-md cursor-pointer">
                                      <FiUpload />
                                      <input
                                        type="file"
                                        ...
                                        accept="image/*"
                                        onChange={(e) =>
                                          handleFileUpload(e, "id_proof_card_back")
                                        }
                                      />
                                    </label>
                                  )}
                                ...
                                <div className="flex space-x-2 mt-2">
                                  ...
                                  <button
                                    ...
                                    onClick={() => {
                                      ...
                                      setPreviewImage(
                                        getPreview(formik.values.passport_photo)
                                      );
                                      setShowPreviewModal(true);
                                    }}
                                    className="inline-flex items-center px-3 py-2 text-sm text-blue-600 bg-blue-50 hover:bg-blue-100 rounded-md"
                                  ...
                                  {/* ⬆ UPLOAD BUTTON */}
                                  {(isEditingDocs || !formik.values.passport_photo) && (
                                  <label className="inline-flex items-center px-3 py-2 text-sm text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-md cursor-pointer">
                                    <FiUpload />
                                    <input
                                      type="file"
                                ...
                                <div className="flex space-x-2 mt-2">
                                  ...
                                  <button
                                    ...
                                    onClick={() => {
                                      ...
                                      setPreviewImage(getPreview(formik.values.corporate_id));
                                      setShowPreviewModal(true);
                                    }}
                                    className="inline-flex items-center px-3 py-2 text-sm text-blue-600 bg-blue-50 hover:bg-blue-100 rounded-md"
                                  >
                                  ...
                                  {/* ⬆ UPLOAD BUTTON */}
                                  {(isEditingDocs || !formik.values.corporate_id) && (
                                  <label className="inline-flex items-center px-3 py-2 text-sm text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-md cursor-pointer">
                                    <FiUpload />
                                    <input
                                      type="file"
