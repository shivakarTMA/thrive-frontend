...
import AlreadyExistLead from "../../components/modal/AlreadyExistLead";
...
const CreateLeadForm = ({ setLeadModal }) => {
  ...
  const formik = useFormik({
    ...
    validationSchema,
    onSubmit: (values) => {
      const enteredNumber = values.personalDetails.contactNumber;
      const user = mockData.find((u) => u.contact === enteredNumber);
            ...
            <form className="space-y-6" onSubmit={formik.handleSubmit}>
              {activeTab === "personal" && (
                <>
                  ...
                  <hr />
                  <h3 className="text-2xl font-semibold">Schedule Details</h3>
                  <div>
                          ...
                          <div className="flex gap-4">
                            ...
                            <div className="custom--date flex-1">
                              <DatePicker
                                ...
                                filterTime={(time) => {
                                  const now = new Date();
                                  const selectedDate = formik.values.schedule
                                    .date
