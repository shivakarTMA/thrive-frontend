  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { resetForm }) => {
      try {
        ...
        if (values.splash_file instanceof File) {
          formData.append("file", values.splash_file);
        }
              ...
              {module.length === 0 ? (
                ...
                module.map((item, index) => (
                  ...
                  >
                    ...
                    <td>
                      <img src={item.splash_file} className="w-14" />
                    </td>
