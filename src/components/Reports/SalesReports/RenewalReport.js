    ...
    <div className="page--content">
      ...
      <div className="flex items-end justify-between gap-2 mb-5">
        <div className="title--breadcrumbs">
          <p className="text-sm">
            {`Home > Reports > Sales Reports > Renewal Report`}
          </p>
              ...
              {data.length ? (
                data.map((row, index) => (
                  ...
                  >
                    ...
                    <td className="px-2 py-4">{row.service_variation}</td>

                    <td className="px-2 py-4">{row.purchase_date}</td>
                ...
                <tr>
                  <td colSpan={12} className="text-center px-2 py-4">
                    No data found
                  </td>
                </tr>
              )}
