    ...
    <div className="page--content">
      ...
      <div className="flex items-end justify-between gap-2 mb-5">
        <div className="title--breadcrumbs">
          <p className="text-sm">
            {`Home > Reports > Operations Reports > Membership Frozen Report`}
          </p>
          <h1 className="text-3xl font-semibold">Membership Frozen Report</h1>
        </div>
      </div>
          ...
          <table className="w-full text-sm text-left text-gray-500">
            <thead className="text-xs text-gray-700 uppercase bg-gray-50">
              <tr>
                ...
                <th className="px-2 py-4 min-w-[130px]">Freeze Start Date</th>
                <th className="px-2 py-4 min-w-[120px]">Freeze End Date</th>
              ...
              {data.length ? (
                data.map((row, index) => (
                  ...
                  >
                    ...
                    <td className="px-2 py-4">{row.freezeStartDate}</td>
                    <td className="px-2 py-4">{row.freezeEndDate}</td>
...
export default MembershipFrozenReport;
