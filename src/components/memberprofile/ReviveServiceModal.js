...
const ReviveServiceModal = ({
  ...
  console.log(extendServiceId, "extendServiceId");
      ...
      <div className="max-w-sm w-full">
        <form onSubmit={formik.handleSubmit}>
          ...
          <div className="flex justify-end gap-2 bg-white px-2 py-3 border-t rounded-b">
            <button
              type="button"
              onClick={() => setReviveService(false)}
...
export default ReviveServiceModal;
