...
const CalendarView = () => {
  ...
  const events = [
    {
      id: 1,
      title: "Fitness Class",
      start: new Date(2025, 9, 1, 7, 0),
      end: new Date(2025, 9, 1, 8, 0),
    ...
    },
    {
      id: 7,
      title: "Crossfit",
      start: new Date(2025, 9, 26, 7, 0),
      end: new Date(2025, 9, 26, 8, 0),
    ...
    },
    {
      id: 8,
      title: "Fitness Class",
      start: new Date(2025, 9, 26, 12, 0),
      end: new Date(2025, 9, 26, 13, 0),
      trainer: "Bhavya Garg",
      type: "fitness",
      bookings: 16,
      waiting: 6,
    ...
    },
    {
      id: 10,
      title: "Crossfit",
      start: new Date(2025, 9, 26, 16, 0),
      end: new Date(2025, 9, 26, 17, 0),
  ...
  const CustomEvent = ({ event }) => {
    ...
    return (
      ...
      >
        {view === "month" ? (
          <div className="font-medium text-xs truncate !text-[#000000]">{event.title}</div>
        ) : (
          <>
            <div className="font-[500] text-sm !text-[#000000]  mb-2">{event.title}</div>
            <div className="text-[10px] mt-0.5 !text-[#6F6F6F]">
              {formatTime(event.start)} - {formatTime(event.end)}
            </div>
            <div className="text-[10px] mt-0.5 !text-[#6F6F6F]">{event.trainer}</div>
          </>
        )}
      </div>
    );
