...
export const ROUTE_PERMISSIONS = {
  ...
  '/': [
    ...
    'FINANCE_MANAGER', 'FINANCE_MANAGER_CLUB', 'FINANCE_MANAGER_CORPORATE', 'F_AND_B', 'RECOVERY'
  ],

  // ─── Lead Management ────────────────────────────────────────────────────────
  '/all-leads': [
    'ADMIN', 'CLUB_MANAGER', 'ASS_CLUB_MANAGER', 'FOH', 'PROGRAM_SPECIALIST', 'FITNESS_MANAGER', 'ASS_FITNESS_MANAGER', 'TRAINER',
  ...
  '/workout-plans': [
    ...
    'FITNESS_MANAGER', 'ASS_FITNESS_MANAGER', 'TRAINER', 'MARKETING_MANAGER', 'RECOVERY'
  ],
  '/create-workout-plan': [
    'ADMIN', 'CLUB_MANAGER', 'ASS_CLUB_MANAGER', 'PROGRAM_SPECIALIST',
    'FITNESS_MANAGER', 'ASS_FITNESS_MANAGER', 'TRAINER', 
  ...
  '/birthday-report': [
    'ADMIN', 'CLUB_MANAGER', 'ASS_CLUB_MANAGER', 'FOH', 'PROGRAM_SPECIALIST',
    'FITNESS_MANAGER', 'ASS_FITNESS_MANAGER', 'TRAINER', 'MARKETING_MANAGER',
    'FINANCE_MANAGER_CORPORATE', 'RECOVERY'
  ],
  '/anniversary-report': [
    'ADMIN', 'CLUB_MANAGER', 'ASS_CLUB_MANAGER', 'FOH', 'PROGRAM_SPECIALIST',
    'FITNESS_MANAGER', 'ASS_FITNESS_MANAGER', 'TRAINER', 'MARKETING_MANAGER',
  ...
  '/reports/appointments/all-trial-appointments': [
    'ADMIN', 'CLUB_MANAGER', 'ASS_CLUB_MANAGER', 'FOH', 'PROGRAM_SPECIALIST',
    'FITNESS_MANAGER', 'ASS_FITNESS_MANAGER', 'TRAINER', 'MARKETING_MANAGER', 'FINANCE_MANAGER_CLUB',
    // Finance Manager Club and Corporate do NOT have access per RBAC
  ],
  '/reports/all-bookings': [
    'ADMIN', 'CLUB_MANAGER', 'ASS_CLUB_MANAGER', 'FOH', 'PROGRAM_SPECIALIST',
    'FITNESS_MANAGER', 'ASS_FITNESS_MANAGER', 'TRAINER', 'MARKETING_MANAGER',
    'FINANCE_MANAGER', 'FINANCE_MANAGER_CLUB', 'FINANCE_MANAGER_CORPORATE', 'RECOVERY'
  ],
  '/reports/all-orders': [
    'ADMIN', 'CLUB_MANAGER', 'ASS_CLUB_MANAGER', 'FOH', 'PROGRAM_SPECIALIST', 'FITNESS_MANAGER',
    'MARKETING_MANAGER', 'FINANCE_MANAGER', 'FINANCE_MANAGER_CLUB', 'FINANCE_MANAGER_CORPORATE', 'F_AND_B', 'RECOVERY'
  ],
  '/nourish-orders': [
    'ADMIN', 'CLUB_MANAGER', 'ASS_CLUB_MANAGER', 'FOH', 'PROGRAM_SPECIALIST',
  ...
  '/whatsapp-template-list': ['ADMIN', 'CLUB_MANAGER', 'ASS_CLUB_MANAGER', 'PROGRAM_SPECIALIST', 'MARKETING_MANAGER'],
  '/send-whatsapp-list': ['ADMIN','CLUB_MANAGER','ASS_CLUB_MANAGER','MARKETING_MANAGER'],
  '/send-whatsapp-list/:id': ['ADMIN','CLUB_MANAGER','ASS_CLUB_MANAGER','MARKETING_MANAGER'],
  '/send-whatsapp': ['ADMIN','CLUB_MANAGER','ASS_CLUB_MANAGER','MARKETING_MANAGER'],
  '/email-template': [
    'ADMIN', 'CLUB_MANAGER', 'ASS_CLUB_MANAGER', 'PROGRAM_SPECIALIST', 'MARKETING_MANAGER',
  ],
  '/email-template/:id': [
  ...
  '/reports/operations-reports/referral-report': [
    'ADMIN', 'CLUB_MANAGER', 'ASS_CLUB_MANAGER', 'PROGRAM_SPECIALIST',
    'FITNESS_MANAGER', 'ASS_FITNESS_MANAGER', 'MARKETING_MANAGER',
    'FINANCE_MANAGER', 'FINANCE_MANAGER_CLUB', 'FINANCE_MANAGER_CORPORATE', 'FOH'
  ],
